...
![5H 잔여량 100%·주간 잔여량 70%의 예시 값을 적용한 Windows 11 작업 표시줄 캡처: 알아보기 쉽도록 주간 초기화 시간 툴팁을 작업 표시줄 위로 옮긴 정상 상태와, 주황색 표시등 및 영향 서비스 상세가 표시된 시뮬레이션 장애 상태를 나란히 보여줍니다.](docs/assets/readme/codexhp-taskbar.ko.png)
...
사용량 페이지를 찾는 대신 작업에 집중하세요. 한도가 얼마나 남았는지, 언제 초기화되는지, 최근 토큰 활동이 어떤 흐름인지 바로 확인할 수 있습니다.
...
오버레이에 마우스를 올리면 초기화까지 남은 시간과, 장애 발생 시 영향을 받는 서비스 상세를 확인할 수 있습니다. 설정에서 **Light**, **Dark**, **System**을 선택해 Windows 환경에 맞추세요.
